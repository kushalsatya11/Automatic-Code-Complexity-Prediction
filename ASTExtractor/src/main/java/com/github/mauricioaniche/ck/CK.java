...
public class CK {
	...
	public CK() {
		final MetricsFinder finder = new MetricsFinder();

		this.classLevelMetrics = new Callable<List<ClassLevelMetric>>() {
			public List<ClassLevelMetric> call() throws Exception {
